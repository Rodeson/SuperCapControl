...
#define Robot_Buffer_PID_KI            0.01f      
#define Robot_Buffer_PID_KD            0.0f

//功率环PID
#define Robot_Power_PID_MODE          PID_DELTA
#define Robot_Power_PID_MAX_OUT       300
#define Robot_Power_PID_MAX_IOUT      80
#define Robot_Power_PID_KP            0.35f    
#define Robot_Power_PID_KI            0.035f      
